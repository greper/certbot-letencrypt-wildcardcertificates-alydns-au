...
import com.ssl.manager.security.vo.LoginRequest;
import com.ssl.manager.security.vo.LoginUser;
import com.ssl.manager.security.vo.TokenResult;
...
public class JwtLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        response.getWriter().write(JsonUtils.toJson(Result.success("登录成功",tokenRet)));
    }
    ...
    protected void unsuccessfulAuthentication(HttpServletRequest request, HttpServletResponse response, AuthenticationException failed) throws IOException, ServletException {
        response.setCharacterEncoding("UTF-8");
        response.getWriter().write(JSONUtil.toJsonStr(Result.error(401,failed.getMessage(),null)));
